...
pub enum HandshakeAck {
    Ok  { server_id: String, protocol_version: u32 },
...
pub enum KernelRpcRequest {
    ...
    // ── Lease ─────────────────────────────────────────────────────────────────
    GrantLease  { call_id: Uuid, pid: u32, ttl_ms: u64 },
    RenewLease  { call_id: Uuid, lease_id: String, ttl_ms: u64 },
    ListLeases  { call_id: Uuid },
}
